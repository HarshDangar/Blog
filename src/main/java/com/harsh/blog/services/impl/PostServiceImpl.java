...
import com.harsh.blog.domain.PostStatus;
...
import com.harsh.blog.repositories.PostRepository;
...
public class PostServiceImpl implements PostService {
    ...
    public List<Post> getAllPost(UUID categoryId, UUID tagId) {
        // Use for getting all post that are published where we have both category id and tag id
        ...
        // We have only category id and tag id is null
        if (categoryId != null) {
            Category category = categoryService.getCategoryById(categoryId);
        ...
        // We have only tag id and category id is null
        if (tagId != null) {
            Tag tag = tagService.getTagById(tagId);
